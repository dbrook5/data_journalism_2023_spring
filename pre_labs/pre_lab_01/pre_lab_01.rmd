...
**Answer** Each line of code is counting the number of classes by terms.
...
**Answer** The number of count classes have been arranged from least to highest. 
...
**Answer** The entire set was grouped by "term" and "department."
...
Compared to the previous codeblock, what has changed and how did that affect the result? 
**Answer** I have more rows and the number of total seats have increased substantially.
...
**Answer** Their are additional columns added to the dataset. All of the top terms end in '8' which means it is referring to the Fall term.
...
**Answer** There are now department names added alongside an array of columns. The data is sorted by total seats, count classes, mean, median, min, and max.
...
1.How many students are taking the courses for their major?

2. Which department has fewest number of seats?


3.  What courses are requiring the maximum number of seats?
