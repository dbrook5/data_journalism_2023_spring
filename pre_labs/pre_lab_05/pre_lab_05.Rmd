...
**Answer** The subhead for the counties is 'maryland' instead of jurisdiction.
...
**Answer** The subheads do not accurately describe the counties and the amount of deaths due to overdose.
...
**Answer** We need to remove the excessive periods from the jurisdictions.
