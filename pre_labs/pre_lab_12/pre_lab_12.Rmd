...
**Answer** After running the following code, there’s a drop down of three words and a special character. The words include “Dog,” “dog,” “cat,” and “,”. I believe the “unique” function allowed the words to drop below the code and in the value column instead of data frame. 
...
**Answer** Once you run the following code, a new data frame titled “unique_words,” was created. There’s one column titled “word” with 647, 091 words that were found in the speech. 
...
**Answer**After running the following code, there is a horizontal bar graph that represents the number of unique words used in Ben Cardin’s releases. “The” was used over 30,000 times, while Maryland was used the least. The letter “d” was recorded in the graph. Did the press release make a typo??
...
**Answer**After running the following code, I noticed that there were 50 rows of unique words used in the press releases. It’s more interesting than before because words such as “health,” and “support,” were the top two in the data frame. While the last two entries were “women,” and “government,” which is surprising because you would think those terms would be a major topic of discussion. 
...
**Answer**The following code produced three separate data frames that were titled “unique_words_2021,” “unique_words_2022,” and “unique_words_2023.” The 2021 data frame featured words such as “health” and “covid” because the pandemic was still prevalent in  society. While in the 2022 data frame, there weren’t any COVID-19 terms because everyone was getting back to their lives. In the 2023 data frame, there were terms of “women,” “rights,” and “national.”
...
**Task** Run the following code and describe the results.
**Answer**There were 11 rows and 3 columns of data after running the code block. Based on line 245, the data was filtered to present data before 1/1/2022. As a result of the data being tracked before 2022 New Year’s Day, COVID-19 was at the top of the list with 576 mentions and 81.5%. On the last page, the name of the United  States Representative is “Kwesi Mfume.” He’s been in office since 2020, so I’m assuming he was involved in the press releases during the pandemic.
...
**Task** Run the following code and describe the results.
**Answer**After running the following codeblock, there were 10 rows of data collected after or equal to 1/1/2022 and before 1/1/2023. I’m a little confused on what line 272 is doing. The data ranged from 137 with “location baltimore” and 434 with “project location.”
...
**Task** Run the following code and describe the results.
**Answer**Once I ran the codeblock, I noticed that there were two word terms that were in range with each other. On line 290, mutate was used to create a new column titled “bigram.” In addition, I believe based on the character in the aforementioned “ “ separated the two words, so that they are legible to interpret the data. It was strange to see “oral health,” and “tax credit,” because those terms weren’t featured in the previous questions of the pre_lab. 
...
**Answer**I noticed that there were three columns with different values to represent the words used in press releases. The columns consists of “word,” “sentiment,” and “n.” The words ranged from “support, “work,” and “protection.” While, in the “sentiment” column, you were either categorized as “positive” or “negative.” The “n” column was tasked with counting and recorded the number of times a term was used. 
