...
**Answer** Yes, they all have the same structure.
...
**Answer** I think it's interesting how the "other" category has gradually increased over time. It started at 275 in 2016 before reaching 1286 in 2022. 
...
**Answer** There are 24 rows and there should be that amount given the number of Maryland jurisdictions.
...
**Answer** It contains demographic data of people's race and the number of voters by race.
...
**Answer** Howard County had the highest  Asian 18+ voters. These numbers are substantially higher than the previous task. The previous task’s highest of Prince George’s is at 60.9%, while Howard is at 19.4%. 
...
**Answer** The datatype starts with Baltimore County’s 20601 and increased by two as the data continued. The number increased by odd numbers until reaching Baltimore City. Once reaching Baltimore city, the ZCTA5N number changed.
...
**Answer** The datatype changed the numbers and put them in quotations juxtaposed to the originial of just being numbered and separated by commas.
```{r}
