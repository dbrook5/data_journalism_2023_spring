...
**Answer** We need the information to determine whether its a grant or a loan. 
...
**Answer** The amount goes from smallest and largest.
...
**Answer** The new headers are spelled regularly with a capital "Z" in zip and "C" in code. The old headers are strictly lowercase and features a underscore. 
...
**Task** Run the following codeblock to use str_sub() to convert the ZIP codes that have nine digits to five digits, creating a new column. Look at the difference in the result - what changed? **Answer** The zip code changed the nine digit ones to five digits.
...
**Task** Write and run code to answer our original question: which zip code has gotten the most amount of money from the Maryland Tourism Board? 648069 -Jackson County, Missouri
