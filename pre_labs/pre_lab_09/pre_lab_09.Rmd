...
**Answer** Copy the url of the graphic you published here. It will begin with https://datawrapper.dwcdn.net/. Don't copy the browser's current url. https://www.datawrapper.de/_/BRM4G/
...
The difference in this map from the previous is that this one is angled in a weird shape. However, it is only showing the Maryland counties because it is the only area with data. 
...
**Answer** Describe the changes from the previous map
The difference in this map is that when you hover over a county in Maryland, you will see the percent numbered like “00.0%” of having too many too many decimal points previously. 
...
**Answer** Put the URL of your map here. https://www.datawrapper.de/_/IhlnU/
