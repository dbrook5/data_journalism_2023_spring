...
```{r echo=FALSE}
census_api_key("3f95bc5c7a6949265b472d95d7a03633eefb898e", overwrite=TRUE)
```
...
**Answer** Wealthiest Counties in Maryland
...
Is the difference between Calvert and Montgomery significant? **Answer** No, the difference between Calvert and Montgomery is not significant. They are relatively close though.
...
**Answer**Calvert County, Anne Arundel County, St. Mary’s County were a few counties that saw a significant increase in median income. I did not notice act median incomes fall from 2010-2021.
...
**Answer**With a few of the top counties (Montgomery, Howard), do graduates live in the surrounding areas or further out? Does the high media incomes of the counties play a role in the top enrollment percentages? The location of the zip codes might make make the answer hard to interpret because they may not live close to their school. 
...
**Answer** The average household for high schools that has 60% or more graduates immediately enrolling in college belongs to families that make over 100k a year. Compared to the household with less than 40% has a significant dip in earnings with 69k a year. 
...
**Answer** What schools in Baltimore County produce the most high school graduates that enroll in college? And what’s the income of the area surrounding the schools?
