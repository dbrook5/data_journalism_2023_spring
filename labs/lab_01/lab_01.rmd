...
**A2** There are roughly 160 classes that have been offered 21 times.
...
**A3** I think James Green of the Engineering Science department has taught the most courses because he has 27,335 total seats and I have not seen any other instructor come close to reaching his number.
...
**A4** I believe it would have been easier to find the answer to Q3 by knowing how to properly arrange the formulas to elicit a quicker and accurate resposnse.
...
**A5** The question that I chose is "Which department has fewest number of seats?" The answer is National Institute of Aeronautics - North Carolina with only two seats. I sifted through the results and the aforementioned department had the least number of seats.
