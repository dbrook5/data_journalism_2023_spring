...
nonvoters_data %>%
  group_by(voter_category,income_cat) %>%
  summarise(
    count=n()
  ) 
...
* **Analysis summary**: [Write up two to three sentences describing the results of your analysis.  Were you able to confirm the finding? If not, why not?] We were able to confirm the finding because we learned about 8% of sporadic voters reported a long term disability. About 5% of voters reported that they have a long term disability. Roughly 12% of voters who say they rarely or never vote reported that they have a long term disability.
